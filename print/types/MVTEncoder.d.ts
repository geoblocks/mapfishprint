...
export default class MVTEncoder {
    ...
    renderTile(featuresExtents: _FeatureExtent[], rtExtent: Extent, canvasSize: [number, number], styleResolution: number, layerStyleFunction: StyleFunction, layerOpacity: number, renderBuffer: number, decluterTree?: RBush<any>, outputFormat?: string): PrintResult;
}
export {};
